...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        NGramMap nGramMap = new NGramMap(SMALL_WORDS_FILE, TOTAL_COUNTS_FILE);

        HyponymsHandler hyponymsHandler = new HyponymsHandler(SMALL_SYNSET_FILE, SMALL_HYPONYM_FILE, nGramMap);
